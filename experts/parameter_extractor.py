...
class ParameterExtractor(BaseExpert):
    ...
    FORWARD_TASK = r'''As a parameter extraction expert, your role is to identify and extract the relevant variables, constraints, objective from the problem statement.
...
'''
    ...
    def __init__(self, model):
        super().__init__(
            ...
            description='Identifies and extracts relevant variables from the problem statement.',
            model=model
        )
        self.llm = ChatOpenAI(
            model=model,
